    ...
    def ready(self):
        ...
        try:
            ...
            c.agent.service.register(
                ...
                port=service_port,
                check={
                    'http': f'http://{host_ip}:{service_port}/api/products/health/?format=json',
                    'interval': '10s'
                }
            )
